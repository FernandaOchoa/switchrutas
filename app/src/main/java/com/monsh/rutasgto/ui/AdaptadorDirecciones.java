...
public class AdaptadorDirecciones
    ...
    public static class Direccion {
        ...
        static {
            DIRECCIONES.add(new Direccion("Cantinas","22/08/2014","Acumulaste 15pts","Califica esta ruta"));
            DIRECCIONES.add(new Direccion("Gastronomica","13/11/2015","Acumulaste 17pts","Califica esta ruta"));
            DIRECCIONES.add(new Direccion("Independencia", "23/03/2015", "Acumulaste 22pts", "Califica esta ruta"));
        }
    }
